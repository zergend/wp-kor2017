  ...
  <div class="footer-inner">
    ...
    <div class="column  column--footer  column--right-footer">
      <div class="footer-inner__rights">
        © 2016 Все права защищены и охраняются законом.<br> Использование материалов сайта разрешено только<br> с разрешения администрации Кораблинского района.<br> При цитировании материалов в сети Интернет<br> гиперссылка на <a href="/">www.korablino62.ru</a>          обязательна.
      </div>
      <div class="footer-inner__autor">
        Разработка и сопровождение: <a href="blogsector.ru">blogsector.ru</a>
      </div>
    </div>
  </div>
</footer>
